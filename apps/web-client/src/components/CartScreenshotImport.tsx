  ...
  return (
    <div className="rounded-xl border border-brand/40 bg-brand-soft/40 p-4 shadow-card">
      ...
      <p className="mt-0.5 text-xs leading-relaxed text-muted">
        Перетащите сюда скриншот корзины Amazon, eBay, AliExpress или любого магазина — ИИ распознает
        товары, цены, стоимость доставки и магазин и сам заполнит форму.
      </p>
      ...
      >
        ...
        <span className="font-medium text-ink">
          {pending ? 'Распознаём корзину…' : 'Перетащите скриншот или нажмите, чтобы выбрать'}
        </span>
      ...
      <p className="mt-2 text-[11px] leading-relaxed text-muted">
        Совет: уменьшите масштаб (Ctrl −), чтобы вся корзина попала на экран, и сверьте распознанные
        данные с корзиной.
      </p>
      ...
      {state.ok ? (
        <p className="mt-2 text-xs text-low">
          ...
          {typeof state.remaining === 'number' ? ` · осталось ИИ-запросов: ${state.remaining}` : ''}
          . Проверьте поля ниже.
        </p>
      ) : null}
    </div>
